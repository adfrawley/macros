	    ...
	    int verbosity = 0)
{
  ...
  //double maps_layer_radius[7] = {23.0, 31.0, 39.0, 194.0, 247.0, 353.0, 405.0};   // ITS radii  (mm)
  //double maps_layer_radius[7] = {23.0, 31.0, 39.0, 194.0, 247.0, 353.0, 640.0}; // ALICE ITS upgrade with outer layer pushed out 
  double maps_layer_radius[7] = {23.635, 31.5, 39.385, 217.6775, 272.07, 363.179, 640.0};   // mm  - adjusted for closest fit
